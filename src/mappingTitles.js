const titleMap = {
  ...
  dogReason: "Reason for wanting a dog",
  ...
  catReason: "Will cat be left at home alone",
  ...
  dogAwareOfCostsAndLegal: "Aware of costs and legal implications of owning a dog",
  ...
  healthConditionSpecialNeeds: "Health conditions or special needs that could affect ability to volunteer",
  healthConditionSpecialNeedsDetails: "Brief details of the health condition or special needs",
  ...
  employeeOrVolunteerAnimals: "Employee or volunteer eith any other charity/organization involved with the care of animals",
  ...
  giftAidPast: "Gift Aid previous donations for the current year, and all the previous four tax years",
  //* Subcategories
