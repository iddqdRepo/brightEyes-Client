...
function About() {
  return (
    <>
      <div className="about-pat-container">
        <div className="about-header">Our Founder</div>

        <div className="about-pat-split-content">
          <div className="about-pat-image-name-container">
            <div className="about-pat-split-image"> </div>

            <div className="about-pat-split-text-title">Pat Nolan</div>
            <div className="about-pat-split-text-subtitle">1946 - 2013</div>
          </div>
          <div className="about-pat-description-container">
            <div className="about-pat-split-text-description">
              <span className="pat-p">P</span> at was a tireless advocate for animal rights and animal welfare. He devoted his whole life to the
              welfare and well-being of all animals that came into his care, often to the detriment of his own health. <br />
              <br />
              Through all the hard times Pat never lost his focus on helping the animals. Each and every one was given the help they needed, despite
              mounting vet and food bills and very limited funding. <br />
              <br />
              Back in the late 70’s Pat and his wife rescued a stray tabby cat to their home in Derrin Park Enniskillen. Little did he know this would
              be the beginning of his success and a lifelong commitment. By the early 80’s Pat had rescued a host of abandoned cats and cared for them
              in his home on the Kilmacormick estate. His reputation was growing and he earned the respected nickname of ‘Pat the cat’. Pat’s next
              move was to a disused farm building in Coa. Pat lived in a cold cramped caravan while the animals, now also dogs, lived in the
              outbuildings. <br />
              <br />
              Pat’s last move was to Killymittan Ballinamallard in 1995. Pat had a good team to support him and turned a dilapidated house and
              outbuildings to the facilities we see today, very impressive considering he received no formal funding, just generous donations from the
              public. <br />
      ...
      <div className="slanted-div-about">
        <div className="slanted-about-header">About Bright Eyes</div>

        <div className="slanted-about-us-split-content">
          <div className="slanted-about-us-split-text">
            <div className="slanted-about-us-split-text-title">Bright Eyes Animal Sanctuary</div>
            <div className="slanted-about-us-split-text-description">
              Bright Eyes was established in 1989, formerly registered with HMRC as a charity and reregistered with the Northern Ireland Charity
          ...
          <div className="slanted-about-us-split-image"> </div>
        </div>
      </div>
      <div className="pat-video-header">An Interview With The Founder</div>
